...
import { AddCagetory, OneCagetory, UpdateCagetory } from '@/api/baseUrl'
...
const EditCategory = () => {
    ...
    useEffect(() => {
        ...
        const onecat = async () => {
            const res = await OneCagetory(id)
            setOnecat(res?.data?.oneCategory)
    ...
    async function onSubmit(values) {
        const res = await UpdateCagetory(id, values)
        form.reset()
